...
---------------------------------------------------------
Define a class Employee which will store information about:

name (array of chars maximum 100 characters) - the employee's name
surname (array of chars maximum 100 characters) - the employee's surname
salary (integer) - how much the employee earns
The methods that the class should have are:
...
Define a class TechCompany which will store information about:

name (string of maximum 100 characters) - the name of the company
employees (array of Employee objects)
numOfEmployees (integer) - how many employees the company has
The methods that the class should have are:

print()
-Prints in the format: Tech company name: Number of employees:
double getAverageOfEmployeeSalary()
-Returns the average value of salaries for each employee in the company.
All variables inside the classes should be private. Accordingly, constructors (with and without parameters), destructors, set methods, get methods, and copy constructors should be defined within the classes.

Functions outside of the class:

printCompanyWithHighestAverageSalary(TechCompany companies[], int numCompanies)
-Returns the TechCompany object that has the highest average salary for its employees.
printCompanyWithHighestStdSalary(TechCompany companies[], int numCompanies)
-Returns the TechCompany object that has the highest standard deviation for its employees' salaries.
VAR=∑for each Employee e[(e.salary−AVG)2]n−1STD=(√VAR)

-Note: AVG is the average value of salaries for all employees in the company, STD is the standard deviation. First square the expression, then add it to the sum!
isSameCompany(TechCompany company1, TechCompany company2)
-Returns a boolean value: two companies are the same if they have the same name. Only the names need to be checked!
